...
namespace Collins.Cloud.App.Models
{
    using System;
    ...
    public partial class TestingDbEntities : DbContext
    {
        ...
        [DbFunction("TestingDbEntities", "ufnGetAllCategories")]
        public virtual IQueryable<ufnGetAllCategories_Result> ufnGetAllCategories()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetAllCategories_Result>("[TestingDbEntities].[ufnGetAllCategories]()");
        }
    
        [DbFunction("TestingDbEntities", "ufnGetCustomerInformation")]
        public virtual IQueryable<ufnGetCustomerInformation_Result> ufnGetCustomerInformation(Nullable<int> customerID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetCustomerInformation_Result>("[TestingDbEntities].[ufnGetCustomerInformation](@CustomerID)", customerIDParameter);
        }
